        ...
        <div>
          ...
          <form onSubmit={submitHandler}>
            ...
            <input
              ...
              required
            />
            <button className='w-full bg-black rounded border-none px-4 py-2 mb-2 text-white font-semibold'>Signup</button>
            <p className='text-sm text-center'>Already have an account?<Link to='/login' className='text-blue-800 font-semibold cursor-pointer'> Login</Link></p>
          </form>
        </div>
